...
$query = "SELECT nesreca.id_nesrece, nesreca.klas_nesrece, krajevne_lastnosti.tip, krajevne_lastnosti.vzrok, nesreca.x, nesreca.y FROM nesreca INNER JOIN krajevne_lastnosti ON nesreca.id_nesrece = krajevne_lastnosti.id_nesrece WHERE nesreca.x > 1 and nesreca.y > 1 LIMIT 5000";
